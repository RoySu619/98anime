...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("list", {
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList($data.list, (item, i) => {
        ...
        createElementVNode("view", { class: "li" }, [
          createElementVNode("view", { class: "li_t" }, [
            ...
            createElementVNode("view", { class: "li_t_r" }, [
              createElementVNode("u-text", { class: "li_t_r_t" }, toDisplayString(item.gmname) + " - " + toDisplayString(item.lbname), 1),
              createElementVNode("u-text", { class: "li_t_r_b" }, "到期时间：" + toDisplayString(item.lbtm), 1)
            ])
          ]),
          createElementVNode("u-text", { class: "li_c" }, "KEY: " + toDisplayString(item.lbkey), 1),
...
const ckx = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]]]);
export {
  ckx as default
};
