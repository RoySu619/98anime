...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("list", {
    ...
    $data.list ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList($data.list, (item, index) => {
      return openBlock(), createElementBlock("cell", {
        ...
        createElementVNode("view", {
          ...
          createElementVNode("view", {
            ...
            createElementVNode("u-text", { class: "gm_c_t" }, toDisplayString(item.gmname) + toDisplayString(item.lbname), 1),
            createElementVNode("u-text", { class: "gm_c_c" }, toDisplayString(item.lbjj), 1),
            createElementVNode("u-text", { class: "gm_c_b" }, "剩余：" + toDisplayString(item.lbsy) + "枚", 1)
          ]),
...
const tab3 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]]]);
export {
  tab3 as default
};
