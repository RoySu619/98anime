...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("list", {
    ...
    createElementVNode("cell", {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList($data.bqlist, (item, index) => {
...
const tab2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]]]);
export {
  tab2 as default
};
