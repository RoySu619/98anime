...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("view", null, [
    createElementVNode("list", {
      ...
      createElementVNode("cell", { class: "lbt" }, [
        createVNode(_component_swiper, {
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList($data.lbt, (item, index) => {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList($data.hotlist, (item, index) => {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList($data.jplist, (item, index) => {
        return openBlock(), createElementBlock("cell", {
          class: "cell",
          key: item.id,
          onClick: ($event) => $options.opgm(item.id)
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList($data.hylist, (item, index) => {
        return openBlock(), createElementBlock("cell", {
          class: "cell",
          key: item.id,
          onClick: ($event) => $options.opgm(item.id)
    ...
    $data.tk_main == 1 ? (openBlock(), createBlock(_component_uni_popup, {
      key: 0,
      type: "center",
      ref: "tkmain",
      "is-mask-click": false,
    ...
    $data.appup_main == 1 ? (openBlock(), createBlock(_component_uni_popup, {
      key: 1,
      type: "bottom",
      ref: "appupmain",
      "is-mask-click": false,
      ...
      default: withCtx(() => [
        createElementVNode("view", {
          ...
          createElementVNode("u-text", { class: "appupmain_t" }, toDisplayString($data.appup_tit), 1),
...
const tab1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]]]);
export {
  tab1 as default
};
