  ...
  return openBlock(), createElementBlock("list", null, [
    createElementVNode("cell", {
      ...
      createElementVNode("view", {
        ...
        createElementVNode("u-text", { class: "top_c_t" }, toDisplayString($data.unick), 1),
        createElementVNode("u-text", { class: "top_c_b" }, "ID: " + toDisplayString($data.uid), 1)
      ]),
    ...
    createElementVNode("cell", { class: "tis" }, [
      createElementVNode("u-text", { class: "tis_t" }, "海口龙华茂绅优选贸易商行版权所有\n当前APP版本：v" + toDisplayString($data.appv), 1)
    ])
  ]);
}
const tab4 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]]]);
export {
  tab4 as default
};
