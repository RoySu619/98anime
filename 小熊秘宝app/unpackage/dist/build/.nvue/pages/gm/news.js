    ...
    $data.list ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList($data.list, (item, index) => {
      return openBlock(), createElementBlock("cell", {
        ...
        createElementVNode("view", {
          ...
          createElementVNode("u-text", { class: "news_t" }, toDisplayString(item.zxname), 1),
          createElementVNode("u-text", { class: "news_c" }, toDisplayString(item.zxjj), 1),
          createElementVNode("u-text", { class: "news_b" }, toDisplayString(item.times), 1)
        ])
      ], 8, ["onClick"]);
...
const news = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]]]);
export {
  news as default
};
