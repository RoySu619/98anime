...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("view", null, [
    ...
    createElementVNode("list", {
      ...
      $data.gmlist ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList($data.gmlist, (item, index) => {
        return openBlock(), createElementBlock("cell", {
          ...
          createElementVNode("view", {
            ...
            createElementVNode("view", {
              ...
              createElementVNode("u-text", { class: "gm_c_c" }, "新服： " + toDisplayString(item.xfname), 1),
              createElementVNode("u-text", { class: "gm_c_b" }, "开服时间：" + toDisplayString(item.kftimes), 1)
            ]),
...
const gmxf = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]]]);
export {
  gmxf as default
};
