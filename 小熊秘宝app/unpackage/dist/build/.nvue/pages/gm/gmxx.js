...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("view", null, [
    createElementVNode("list", {
      ...
      createElementVNode("cell", { class: "m_t" }, [
        ...
        createElementVNode("view", {
          ...
          createElementVNode("u-text", { class: "m_t_c_t1" }, toDisplayString($data.gmname), 1),
          createElementVNode("u-text", { class: "m_t_c_t2" }, toDisplayString($data.gmbq) + " . " + toDisplayString($data.gmmb), 1),
          $data.gmpf == "1" ? (openBlock(), createElementBlock("u-text", {
            key: 0,
            class: "m_t_c_t3"
          }, " " + toDisplayString($data.gmpf) + "分", 1)) : createCommentVNode("", true),
          $data.gmpf == "2" ? (openBlock(), createElementBlock("u-text", {
            key: 1,
            class: "m_t_c_t3"
          }, "  " + toDisplayString($data.gmpf) + "分", 1)) : createCommentVNode("", true),
          $data.gmpf == "3" ? (openBlock(), createElementBlock("u-text", {
            key: 2,
            class: "m_t_c_t3"
          }, "   " + toDisplayString($data.gmpf) + "分", 1)) : createCommentVNode("", true),
          $data.gmpf == "4" ? (openBlock(), createElementBlock("u-text", {
            key: 3,
            class: "m_t_c_t3"
          }, "    " + toDisplayString($data.gmpf) + "分", 1)) : createCommentVNode("", true),
          $data.gmpf == "5" ? (openBlock(), createElementBlock("u-text", {
            key: 4,
            class: "m_t_c_t3"
          }, "     " + toDisplayString($data.gmpf) + "分", 1)) : createCommentVNode("", true)
        ]),
        createElementVNode("u-text", { class: "m_t_r" }, toDisplayString($data.gmdow) + "次下载", 1)
      ]),
      $data.gmqun ? (openBlock(), createElementBlock("cell", {
        ...
        createElementVNode("view", {
          ...
          createElementVNode("view", {
            ...
            createElementVNode("u-text", { class: "cell_qun_l_t" }, "已有" + toDisplayString($data.gmdow) + "人在玩", 1),
      ...
      $data.tabid == 1 ? (openBlock(), createElementBlock("cell", {
        ...
        createElementVNode("scroll-view", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList($data.gmimg, (item, index) => {
        ...
        createElementVNode("u-text", { class: "jj" }, toDisplayString($data.gmjj), 1),
        createElementVNode("u-text", { class: "tit" }, "-- 游戏介绍 --"),
        createElementVNode("u-text", { class: "jj" }, toDisplayString($data.gmjs), 1)
      ])) : createCommentVNode("", true),
      $data.tabid == 2 && $data.lblist ? (openBlock(), createElementBlock("cell", {
        key: 2,
        class: "cell"
      }, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($data.lblist, (item, index) => {
          return openBlock(), createElementBlock("view", {
            ...
            createElementVNode("view", {
              ...
              createElementVNode("u-text", { class: "lbli_l_t1" }, toDisplayString(item.lbname), 1),
              createElementVNode("u-text", { class: "lbli_l_t2" }, toDisplayString(item.lbjj), 1),
              createElementVNode("u-text", { class: "lbli_l_t3" }, "剩余：" + toDisplayString(item.lbsy) + "枚", 1)
            ]),
      ...
      $data.tabid == 3 && $data.nelist ? (openBlock(), createElementBlock("cell", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList($data.nelist, (item, index) => {
          return openBlock(), createElementBlock("view", {
            class: "neli",
            ...
            createElementVNode("u-text", { class: "neli_t1" }, toDisplayString(item.zxname), 1),
            createElementVNode("u-text", { class: "neli_t2" }, toDisplayString(item.zxjj), 1),
            createElementVNode("u-text", { class: "neli_t3" }, toDisplayString(item.times), 1)
          ], 8, ["onClick"]);
        }), 128))
      ])) : createCommentVNode("", true),
      $data.tabid == 3 && $data.nelist == "" ? (openBlock(), createElementBlock("cell", {
    ...
    createElementVNode("view", {
      ...
      createElementVNode("u-text", { class: "dow_an" }, toDisplayString($data.dowzttis), 1)
    ], 4)
  ]);
}
const gmxx = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]]]);
export {
  gmxx as default
};
