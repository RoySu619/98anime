...
(() => {
  ...
  // F:/360MoveData/Users/abc/Desktop/小熊秘宝/unpackage/dist/dev/.nvue/pages/gm/gmxf.js
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", null, [
      (0, import_vue.createElementVNode)("view", { class: "tp" }, [
        (0, import_vue.createElementVNode)("view", {
          class: "tpli",
          onClick: _cache[0] || (_cache[0] = ($event) => $options.settab(1))
        }, [
          (0, import_vue.createElementVNode)("u-text", { class: "tpli_t" }, "\u4ECA\u65E5\u63A8\u8350"),
        ...
        (0, import_vue.createElementVNode)("view", {
          ...
          (0, import_vue.createElementVNode)("u-text", { class: "tpli_t" }, "\u660E\u65E5\u63A8\u8350"),
        ...
        (0, import_vue.createElementVNode)("view", {
          ...
          (0, import_vue.createElementVNode)("u-text", { class: "tpli_t" }, "\u5386\u53F2\u8BB0\u5F55"),
                ...
                (0, import_vue.createElementVNode)("view", {
                  ...
                  (0, import_vue.createElementVNode)("view", {
                    ...
                    (0, import_vue.createElementVNode)(
                      "u-text",
                      { class: "gm_c_c" },
                      "\u65B0\u670D\uFF1A " + (0, import_vue.toDisplayString)(item.xfname),
                      1
                      /* TEXT */
                    ),
                    (0, import_vue.createElementVNode)(
                      "u-text",
                      { class: "gm_c_b" },
                      "\u5F00\u670D\u65F6\u95F4\uFF1A" + (0, import_vue.toDisplayString)(item.kftimes),
                      1
                      /* TEXT */
                    )
                  ]),
  ...
  var gmxf = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "F:/360MoveData/Users/abc/Desktop/\u5C0F\u718A\u79D8\u5B9D/pages/gm/gmxf.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/gm/gmxf";
    let __pageQuery = {};
    try {
    ...
    gmxf.mpType = "page";
    const app = Vue.createPageApp(gmxf, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...gmxf.styles || []]));
    app.mount("#root");
  }
})();
