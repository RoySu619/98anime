...
(() => {
  ...
  // F:/360MoveData/Users/abc/Desktop/小熊秘宝/unpackage/dist/dev/.nvue/pages/user/msg.js
  var import_vue = __toESM(require_vue());
  var _style_0 = { "m": { "": { "width": "750rpx" } }, "ml": { "": { "flexDirection": "row", "flexWrap": "nowrap", "justifyContent": "space-between", "alignItems": "center", "width": "750rpx", "borderRadius": "20rpx", "height": "120rpx" } }, "li": { "": { "flexDirection": "row", "flexWrap": "nowrap", "justifyContent": "space-between", "alignItems": "center", "width": "750rpx", "height": "120rpx", "borderBottomWidth": "0.5rpx", "borderBottomStyle": "solid", "borderBottomColor": "rgba(0,0,0,0.05)" } }, "li_l": { "": { "width": "490rpx", "height": "50rpx", "lineHeight": "50rpx", "lines": 1, "fontSize": "26rpx", "paddingLeft": "30rpx", "color": "rgba(0,0,0,0.5)" } }, "li_r": { "": { "width": "150rpx", "height": "50rpx", "lineHeight": "50rpx", "fontSize": "26rpx", "fontFamily": "iconfont", "textAlign": "center" } } };
  var _sfc_main = {
    data() {
      return {
        ip: G_APP.ip,
          ...
          return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("cell", {
            ...
            (0, import_vue.createElementVNode)("view", { class: "li" }, [
              (0, import_vue.createElementVNode)(
                "u-text",
                { class: "li_l" },
                (0, import_vue.toDisplayString)(item.ggtp),
                1
                /* TEXT */
              ),
              (0, import_vue.createElementVNode)("u-text", { class: "li_r" }, "\u67E5\u770B\u8BE6\u7EC6 \uE630")
            ])
          ], 8, ["onClick"]);
        }),
        128
  ...
  var msg = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "F:/360MoveData/Users/abc/Desktop/\u5C0F\u718A\u79D8\u5B9D/pages/user/msg.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/user/msg";
    let __pageQuery = {};
    try {
    ...
    msg.mpType = "page";
    const app = Vue.createPageApp(msg, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...msg.styles || []]));
    app.mount("#root");
  }
})();
