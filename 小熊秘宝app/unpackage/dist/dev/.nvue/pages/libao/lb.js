...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("list", { class: "lb_m" }, [
    createElementVNode("cell", { class: "lb_m_t" }, [
      ...
      createElementVNode("view", { class: "lb_m_t_r" }, [
        ...
        createElementVNode(
          "u-text",
          { class: "lb_m_t_r_t3" },
          "剩余：" + toDisplayString($data.lb_lbsy) + "枚",
          1
          /* TEXT */
        )
      ])
    ...
    createElementVNode("cell", { class: "lb_cells" }, [
      ...
      }, "领取礼包")) : createCommentVNode("v-if", true),
      $data.lb_key ? (openBlock(), createElementBlock("u-text", {
        key: 1,
        class: "lb_m_an2",
        onClick: _cache[1] || (_cache[1] = (...args) => $options.fz && $options.fz(...args))
      }, "复制礼包KEY")) : createCommentVNode("v-if", true)
    ])
  ]);
}
const lb = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "F:/360MoveData/Users/abc/Desktop/小熊秘宝/pages/libao/lb.nvue"]]);
export {
  lb as default
};
