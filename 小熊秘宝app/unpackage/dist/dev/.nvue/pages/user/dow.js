          ...
          createElementVNode("view", {
            ...
            createElementVNode("view", {
              ...
              createElementVNode(
                "u-text",
                { class: "li_c_b" },
                toDisplayString((item.dow_mb / 1024 / 1024).toFixed(2)) + "M",
                1
                /* TEXT */
              )
            ]),
            createElementVNode("view", {
              ...
              item.dow_zt == 0 ? (openBlock(), createElementBlock(
                "u-text",
                {
                  key: 1,
                  class: "li_r_jd"
                },
                toDisplayString(item.dow_jd) + "%",
                1
                /* TEXT */
              ...
              }, "删除", 8, ["onClick"])) : createCommentVNode("v-if", true)
            ])
          ])
        ]);
      }),
...
const dow = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "F:/360MoveData/Users/abc/Desktop/小熊秘宝/pages/user/dow.nvue"]]);
export {
  dow as default
};
