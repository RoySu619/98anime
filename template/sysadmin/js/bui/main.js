...
define('common/main',['bui/menu','bui/tab'],function(require) {
  ...
  BUI.augment(mainPage,{
    ...
    _initContents : function () {
      ...
      //初始化二级菜单一级Tab
      $.each(modulesConfig,function(index,module){//logo 等
        var id = module.id,
          temp =['<li class="dl-tab-item ks-hidden">'+
		  '<div class="dl-second-nav">'+
		  '<div class="dl-second-tree" id="J_',id,'Tree">'+
		  '<div class="muelist" id="muelist" style="display:block;">'+
		  '<div class="xiugaifk"><div class="xiugai" onclick="xmylogo();" title="修改"></div></div>'+
		  '<div class="uslogos"><div id="ulogo"><img src="/template/sysadmin/image/admin.png"></div>'+
		  '<div class="nick" id="nick">未设置 </div>'+
		  '<div class="xxxx">'+
		  '<div class="qian" id="qian">$00.00</div>'+
		  '<div class="exs" id="exs">Ex:0</div>'+
		  '<div class="qxian" id="qxian"></div>'+
		  '</div></div></div></div>'+
		  '<div class="fwqcpu" id="fwqcpu"><b>CPU使用率</b><p id="cpu">0%</p><em><span id="cpujd"></span></em></div>'+
		  '<div class="fwqnc" id="fwqnc"><b>内存使用情况</b><p id="nc">0%</p><em><span id="ncjd"></span></em></div>'+
		  '<div class="', CLS_LEFT_SLIB, '-con" onclick="yclist();" id="headertab">'+
		  '<div class="', CLS_LEFT_SLIB, '"></div></div></div><div class="dl-inner-tab" id="J_',id,'Tab">'+
		  '<div class="logo" ></div>'+
		  '<div class="header" id="header">'+
		  '<span  onclick="opfk();" title="反馈邮件"><i id="msg" title="未读邮件"></i><s></s></span>'+
		  '<div class="msgtx" title="未读消息"><i id="msg" title="未读消息"></i><s></s>'+
		  '<div class="gqmsg"  onclick="opgqcx();" title="待处理过期的小程序"><em></em><span onclick="opgqcx();">有即将过期的小程序</span></div>'+
		  '<div class="ddmsg" title="待处理订单"><em></em><span>您有未处理的订单！</span></div></div>'+
		  '<div class="shezhi" onclick="xmylogo();" title="设置"></div><a href="../sysadmin.php?to=outlogin&login=out"><b title="退出"></b></a>'+
		  '<div class="quanp" title="全屏" onclick="opquanping(document.documentElement);"></div>'+
		  '<a href="../index.php" target="_blank"><div class="pcgo" title="网站首页"></div></a>'+
		  '</div></div></li>'].join('');
...
var opquanping =function(element){
 ...
 $('.quanp').attr('onclick','clquanping();');
 $('.quanp').css('background','url(../image/cqp.png) center no-repeat');
}



var clquanping =  function () {
 ...
 if (exitMethod) {
  ...
  $('.quanp').attr('onclick','opquanping(document.documentElement)');
   $('.quanp').css('background','url(../image/qp.png) center no-repeat');
}
