...
function(t, e) {
	...
	function ue(t, e, i) {
		var n = Px(),
			...
			a = e.getHeight(),
			r = n.style;
		return r && (r.position = "absolute", r.left = 0, r.top = 0, r.width ="100%", r.height = a + "px", n.setAttribute("data-zr-dom-id", t)), n.width = o * i, n.height = a * i, n
	}
	function ce(t) {
		if ("string" == typeof t) {
			var e = R_.get(t);
	...
	function oi(t, e) {
		...
		return i.style.cssText = ["position:relative", "overflow:hidden", "width:100%", "height:" + e + "px", "padding:0", "margin:auto", "border-width:0"].join(";") + ";", i
	}
	function ai(t) {
	...
	function Li(t, e) {
		function i(t, e, i) {
			for (var n = 0, o = t.length; n < o; n++) for (var a = t[n].seriesId, r = Si(t[n].dataIndex), s = i && i[a], l = 0, h = r.length; l < h; l++) {
				var u = r[l];
	...
	function Na(t) {
		var e = t && t.itemStyle;
		if (e) for (var i = 0, o = KS.length; i < o; i++) {
			var a = KS[i],
				r = e.normal,
				s = e.emphasis;
	...
	function Ra(t) {
		...
		if (e) for (var i = 0, n = yw.length; i < n; i++) {
			var o = yw[i];
	...
	function Va(t) {
		if ($S(t)) {
			...
			if ((e = t.markPoint) && e.data) for (var r = e.data, s = 0; s < r.length; s++) Ba(r[s]);
			if ((i = t.markLine) && i.data) for (var l = i.data, s = 0; s < l.length; s++) y(l[s]) ? (Ba(l[s][0]), Ba(l[s][1])) : Ba(l[s]);
	...
	function Oh(t, e, i, n, o, a, r) {
		...
		for (var h, u = 0, c = t.length, d = [], f = [], p = 0; p < c; p++)(h = t[p].y - u) < 0 &&
		function(e, i, n, o) {
	...
	function Qd(t) {
		return t = nf(t), function(e, i) {
			return yo(e, t)
		}
	}
	function tf(t, e) {
		return t = nf(t), function(i) {
			var n = null != e ? e : i,
	...
	function(t) {
		setTimeout(t, 16)
	}, R_ = new o_(50), B_ = {}, V_ = 0, G_ = 5e3, W_ = /\{([a-zA-Z0-9_]+)\|([^}]*)\}/g, F_ = "12px sans-serif", H_ = {};
	...
	function(t) {
		...
		function() {}, this._clips = [], this._running = !1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, Hx.call(this)
	};
	tw.prototype = {
		constructor: tw,
		addClip: function(t) {
			...
			if (t.length) {
				...
				for (d(t, function(t) {
					...
					var u = l.pop(),
						c = s[u],
						f = !! h[u];
					f && (n.call(o, u, c.originalDeps.slice()), delete h[u]), d(c.successor, f ?
					function(t) {
						h[t] = !0, a(t)
					} : a)
				}
	...
	var hM = Pi(),
		uM = IS.extend({
			...
			formatTooltip: function(t, e, i) {
				...
				}(s) : n(r ? Ja(o, t, a[0]) : l ? s[0] : s), c = jo(h), f = o.getName(t), g = this.name;
	...
	xI.type = "list", xI.hasItemOption = !0, xI.getDimension = function(t) {
		...
		var i = 0;
		if (this._storage[t]) for (var n = 0, o = this.count(); n < o; n++) {
		...
		var i = this._storage[t],
			n = this._chunkSize;
		if (i) for (var o = 0, a = this.count(); o < a; o++) {
			var r = o % n;
		...
		if (this._count) {
			...
			if (o) {
				...
				if (!this._indices && !e) {
					var d = 0;
					if (1 === o) {
						for (var f = this._storage[i[0]], p = 0; p < this._chunkCount; p++) for (var g = f[p], m = Math.min(this._count - p * this._chunkSize, this._chunkSize), v = 0; v < m; v++)(b = g[v]) >= h && b <= u && (r[s++] = d), d++;
						c = !0
					} else if (2 === o) {
	...
	var rA = function(t, e, i) {
		...
		sA = {
			updateSelectedMap: function(t) {
				...
				else for (var e = t, i = e.mapDimension("value"), t = this._targetList = [], n = 0, o = e.count(); n < o; n++) t.push({
					name: e.getName(n),
					value: e.get(i, n),
	...
	], AA = 0; AA < TA.length; AA++) for (var DA = 0; DA < TA[AA].length; DA++) TA[AA][DA][0] /= 10.5, TA[AA][DA][1] /= -14, TA[AA][DA][0] += IA[0], TA[AA][DA][1] += IA[1];
	var CA = {
		"南海诸岛": [32, 80],
		"广东": [0, -10],
		"香港": [10, 5],
