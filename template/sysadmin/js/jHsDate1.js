(function ($) {
    var cy=new Date();
    var ccy = cy.getFullYear()+3;
	var ccyy = cy.getFullYear();
	var ccm = cy.getMonth() + 1;
	var ccd = cy.getDate();
	maxtm=ccy+"-"+ccm+"-"+ccd+" 23:59:59";
	mintm=ccyy+"-"+ccm+"-"+ccd+" 00:00:00";
    var defaultSettings = {
    ...
    function setMinute() {
       ...
       /* for (var i = 0; i < 60; i++) {
		...
		setminuteHtml += "<li class='hs_minute'>00分</li>"
		setminuteHtml += "<li class='hs_minute'>30分</li>"
